...
const ReservationPage = () => {
  ...
  const handleConfirmation = async () => {
    ...
    await (creatNewOrder(orderDetails)).then(async () => {
      ...
      await (updateOccupiedSeats(reservationDetails[0].id, selectedSeats.join(','))).then(() => {
    ...
    <div className='page-container'>
      <div className="card-container-reservation">
        ...
        >
          ...
          <button className="button" onClick={handleConfirmation} disabled={hasNoSelectedSeats()} >
            Reserve now!
          </button>
